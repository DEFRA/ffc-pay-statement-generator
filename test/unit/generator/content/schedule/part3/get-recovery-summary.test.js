...
describe('Get recovery summary', () => {
  ...
  test('should return "Reduction: recoverySchedule.adjustment.adjustmentValue" for key stack 2 line 2 entry', () => {
    const result = getRecoverySummary(recoverySchedule)
  ...
  test('should return "\nAn invoice for recoverySchedule.remainingAmount is included with this email" for key stack 2 line 6 entry', () => {
    const result = getRecoverySummary(recoverySchedule)
