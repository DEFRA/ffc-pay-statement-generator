# FFC Payment Statement Generator
...
In order to verify the format set by RPA regarding the PDF filename structure, a regular expression has been created 
that will look for the following formats:
...
Date and Time ( example : yyyymmddhhmm ) : 12 digits
